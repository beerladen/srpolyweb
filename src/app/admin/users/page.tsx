...
import { getManagedAdminRoles, getManagedAdminUsers, getPasswordResetRequests } from "@/lib/admin-user-management";
...
export default async function UsersPage() {
  ...
  const [users, roles, passwordResetRequests] = await Promise.all([
